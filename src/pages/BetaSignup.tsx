          ...
          >
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
              ...
              <div>
                ...
                <div className="p-6 rounded-2xl bg-secondary/50 border border-border group transition-all duration-300 ease-out hover:border-brand-purple/50 hover:shadow-[0_0_20px_rgba(139,92,246,0.2)]">
