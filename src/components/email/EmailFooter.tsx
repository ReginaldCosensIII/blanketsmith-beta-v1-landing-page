...
import wordmarkNoSloganWhite from "@/assets/wordmark-no-slogan-white.svg";
...
export function EmailFooter({ isDarkMode }: EmailFooterProps) {
  ...
  const logo = isDarkMode ? wordmarkNoSloganWhite : logoHorizontal;
...
export function getEmailFooterHTML(
  ...
  return `
    <table width="100%" cellpadding="0" cellspacing="0" style="background-color: ${bgColor}; border-top: 1px solid ${borderColor};">
      <tr>
        <td align="center" style="padding: 32px 20px 24px;">
          <img src="${logoUrl}" alt="BlanketSmith" width="160" style="display: block; max-width: 160px; height: auto; margin-bottom: 20px;" />
